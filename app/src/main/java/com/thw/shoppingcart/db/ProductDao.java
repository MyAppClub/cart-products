    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PRODUCT\" (" + //
                "\"PRODUCT_ID\" INTEGER PRIMARY KEY ," + // 0: productId
    ...
    /** Internal query to resolve the "products" to-many relationship of Category. */
    public List<Product> _queryCategory_Products(long categoryId) {
        synchronized (this) {
            if (category_ProductsQuery == null) {
                QueryBuilder<Product> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.CategoryId.eq(null));
                category_ProductsQuery = queryBuilder.build();
            }
        }
        Query<Product> query = category_ProductsQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN CATEGORY T0 ON T.\"CATEGORY_ID\"=T0.\"CATEGORY_ID\"");
            builder.append(' ');
